    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Learn about the advanced configuration options for your Uniswap V2 adapter
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-muted p-3 rounded-md">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li><strong>Default:</strong> 2 hours - A good balance for most use cases</li>
              ...
              <div className="bg-blue-50 dark:bg-blue-950 p-3 rounded-md">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>For production monitoring, 1-2 hours is recommended</li>
                  <li>For historical analysis or batch processing, 4-6 hours may be sufficient</li>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-muted p-3 rounded-md">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li><strong>Flush Interval:</strong> 2 hours (default) - Good balance</li>
                </ul>
              </div>
            </div>
          </div>
